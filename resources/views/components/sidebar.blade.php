...
>
    ...
    <aside
        ...
        {{ $attributes->merge(['class' => 'fixed top-0 bottom-0 left-0 z-40 w-64 bg-white dark:bg-zinc-950 border-r border-zinc-200 dark:border-zinc-800 p-4 flex flex-col justify-between transition-transform duration-200 ease-in-out']) }}
    >
        <div class="space-y-6">
            {{-- Header / Brand --}}
