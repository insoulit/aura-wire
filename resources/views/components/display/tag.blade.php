...
<span {{ $attributes->merge(['class' => "inline-flex items-center w-fit shrink-0 whitespace-nowrap transition-all duration-150 {$shapeClass} {$sizeClasses} {$variantClasses}"]) }}>
    {{ $slot }}
</span>
